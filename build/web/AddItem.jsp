...
<head>
    <script>
        function valid()
        {
            var a=document.f1.itemName.value;
            var b=document.f1.categoryId.value;
            var c=document.f1.qnt.value;
            var d=document.f1.cost.value;
	...
	<div id="templatemo_container">
		...
		<div id="templatemo_content">
			...
			<div id="templatemo_content_right">
				<div class="templatemo_product_box">
					<h1>Add Item</h1>
                                        <form action="cook?action=addItem" method="post" name="f1" onsubmit="return valid()">
						<table width="100%">
							<%
